...
A = [states(4) states(5) states(6) 0 -g 0]';
x_p = A  + B*controls;
...
args.lbx(3:n_states:n_states*(N+1),1) = -pi/4; %state z lower bound
args.ubx(3:n_states:n_states*(N+1),1) = pi + pi/4;  %state z upper bound
